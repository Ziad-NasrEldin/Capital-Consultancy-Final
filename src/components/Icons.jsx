/**
 * Lightweight inline SVG icons to replace lucide-react (40KiB savings)
 * Optimized for both desktop and mobile (Gzip ~0.3KiB per icon)
 */
...
export const PenLineIcon = ({ size = 24, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className={className}>
